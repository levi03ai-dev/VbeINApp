...
import { PageTransition } from "@/components/music/PageTransition";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VibeIN — Premium Music, Beautifully" },
      {
        name: "description",
        content:
          "A premium music experience: curated albums, radio, and playlists made just for you.",
      },
      { name: "author", content: "VibeIN" },
      { property: "og:title", content: "VibeIN — Premium Music, Beautifully" },
      {
